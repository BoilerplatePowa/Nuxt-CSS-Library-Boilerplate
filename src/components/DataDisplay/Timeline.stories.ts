...
const meta: Meta<typeof Timeline> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A timeline component that shows a list of events in chronological order using DaisyUI\'s timeline structure. Supports optional custom icons and complex content variants.',
      },
    },
  },
  argTypes: {
