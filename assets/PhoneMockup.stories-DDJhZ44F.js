import{d as b,c as x,a as g,b as r,n as u,e as h,o as y}from"./iframe-DJmXHO36.js";import{_ as w}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./preload-helper-D9Z9MdNV.js";const k={class:"display"},v=b({__name:"PhoneMockup",props:{variant:{default:"default"},color:{default:"black"},size:{default:"md"}},setup(t){const s=t,m=x(()=>{const e=["mockup-phone"];return s.variant==="border"?e.push("border"):s.variant==="bg"&&e.push("bg-base-300"),s.color==="black"?e.push("phone-black"):s.color==="white"?e.push("phone-white"):s.color==="gold"?e.push("phone-gold"):s.color==="silver"?e.push("phone-silver"):s.color==="primary"?e.push("phone-primary"):s.color==="secondary"?e.push("phone-secondary"):s.color==="accent"&&e.push("phone-accent"),s.size==="sm"?e.push("phone-sm"):s.size==="lg"?e.push("phone-lg"):s.size==="xl"&&e.push("phone-xl"),e.join(" ")}),f=x(()=>["artboard","artboard-demo","phone-1"].join(" "));return(e,p)=>(y(),g("div",{class:u(m.value)},[p[0]||(p[0]=r("div",{class:"camera"},null,-1)),r("div",k,[r("div",{class:u(f.value)},[h(e.$slots,"default",{},void 0,!0)],2)])],2))}}),a=w(v,[["__scopeId","data-v-a3c6f649"]]);v.__docgenInfo={exportName:"default",displayName:"PhoneMockup",description:"",tags:{},props:[{name:"variant",required:!1,type:{name:"union",elements:[{name:'"default"'},{name:'"border"'},{name:'"bg"'}]},defaultValue:{func:!1,value:"'default'"}},{name:"color",required:!1,type:{name:"union",elements:[{name:'"black"'},{name:'"white"'},{name:'"gold"'},{name:'"silver"'},{name:'"primary"'},{name:'"secondary"'},{name:'"accent"'}]},defaultValue:{func:!1,value:"'black'"}},{name:"size",required:!1,type:{name:"union",elements:[{name:'"sm"'},{name:'"md"'},{name:'"lg"'},{name:'"xl"'}]},defaultValue:{func:!1,value:"'md'"}}],slots:[{name:"default"}],sourceFiles:["/home/runner/work/Nuxt-CSS-Library-Boilerplate/Nuxt-CSS-Library-Boilerplate/src/components/Mockup/PhoneMockup.vue"]};const S={title:"Mockup/PhoneMockup",component:a,parameters:{layout:"centered",docs:{description:{component:"Mobile device mockup component for showcasing mobile apps and responsive designs."}}},argTypes:{color:{control:{type:"select"},options:["black","white","gold","silver"],description:"Phone frame color"},size:{control:{type:"select"},options:["sm","md","lg"],description:"Phone mockup size"},variant:{control:{type:"select"},options:["iphone","android","modern"],description:"Phone style variant"}},tags:["autodocs"]},l={args:{color:"black",size:"md"},render:t=>({components:{PhoneMockup:a},setup(){return{args:t}},template:`
    ...
    `})},n={args:{color:"white",size:"lg"},render:t=>({components:{PhoneMockup:a},setup(){return{args:t}},template:`
      <PhoneMockup v-bind="args">
    ...
    `})},i={args:{color:"black",size:"md"},render:t=>({components:{PhoneMockup:a},setup(){return{args:t}},template:`
      <PhoneMockup v-bind="args">
    ...
    `})},o={args:{color:"white",size:"md"},render:t=>({components:{PhoneMockup:a},setup(){return{args:t}},template:`
      <PhoneMockup v-bind="args">
        <div class="bg-white h-full flex flex-col">
          <!-- Header -->
    ...
    `})},c={render:()=>({components:{PhoneMockup:a},template:`
    ...
    `})},d={render:()=>({components:{PhoneMockup:a},template:`
...
}`,...d.parameters?.docs?.source}}};const z=["Default","AppInterface","MusicPlayer","ECommerceApp","DifferentSizes","Colors"];export{n as AppInterface,d as Colors,l as Default,c as DifferentSizes,o as ECommerceApp,i as MusicPlayer,z as __namedExportsOrder,S as default};
