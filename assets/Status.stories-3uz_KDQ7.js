import{_ as a}from"./Status-DUuhWD6O.js";import"./iframe-BHDwIEoY.js";import"./preload-helper-D9Z9MdNV.js";const v={title:"Data Display/Status",component:a,parameters:{layout:"centered",docs:{description:{component:"A status indicator component for showing online/offline states and other status information."}}},tags:["autodocs"],argTypes:{variant:{control:{type:"select"},options:["primary","secondary","accent","neutral","info","success","warning","error"],description:"Status variant color"},animation:{control:{type:"select"},options:["pulse","bounce","none"],description:"Animation type"},size:{control:{type:"select"},options:["xs","sm","md","lg","xl"],description:"Status size"},ariaLabel:{control:{type:"text"},description:"Accessibility label"}}},s={render:c=>({components:{Status:a},setup(){return{args:c}},template:`
      <Status v-bind="args" />
    `}),args:{variant:"neutral",animation:"none",size:"md",ariaLabel:"status"}},t={render:()=>({components:{Status:a},template:`
      <div class="space-y-4">
    ...
    `})},n={render:()=>({components:{Status:a},template:`
      <div class="space-y-4">
    ...
    `})},e={render:()=>({components:{Status:a},template:`
      <div class="space-y-4">
    ...
    `})},i={render:()=>({components:{Status:a},template:`
      <div class="space-y-4">
        <div>
    ...
    `})},r={render:()=>({components:{Status:a},template:`
      <div class="space-y-4">
    ...
    `})},l={render:()=>({components:{Status:a},template:`
      <div class="space-y-6">
        <div>
...
}`,...l.parameters?.docs?.source}}};const d=["Default","AllVariants","AllSizes","AllAnimations","SimpleExamples","Interactive","CombinedVariants"];export{e as AllAnimations,n as AllSizes,t as AllVariants,l as CombinedVariants,s as Default,r as Interactive,i as SimpleExamples,d as __namedExportsOrder,v as default};
