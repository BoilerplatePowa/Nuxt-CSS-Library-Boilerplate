import{d as b,c as x,a as g,b as r,n as u,e as h,o as y}from"./iframe-DxBZQA7Y.js";import{_ as w}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./preload-helper-D9Z9MdNV.js";const k={class:"display"},v=b({__name:"PhoneMockup",props:{variant:{default:"default"},color:{default:"black"},size:{default:"md"}},setup(s){const t=s,m=x(()=>{const e=["mockup-phone"];return t.variant==="border"?e.push("border"):t.variant==="bg"&&e.push("bg-base-300"),t.color==="black"?e.push("border-black"):t.color==="white"?e.push("border-white"):t.color==="primary"?e.push("border-primary"):t.color==="secondary"?e.push("border-secondary"):t.color==="accent"&&e.push("border-accent"),t.size==="sm"?e.push("scale-75"):t.size==="lg"&&e.push("scale-125"),e.join(" ")}),f=x(()=>["artboard","artboard-demo","phone-1"].join(" "));return(e,p)=>(y(),g("div",{class:u(m.value)},[p[0]||(p[0]=r("div",{class:"camera"},null,-1)),r("div",k,[r("div",{class:u(f.value)},[h(e.$slots,"default",{},void 0,!0)],2)])],2))}}),a=w(v,[["__scopeId","data-v-18f79a8a"]]);v.__docgenInfo={exportName:"default",displayName:"PhoneMockup",description:"",tags:{},props:[{name:"variant",required:!1,type:{name:"union",elements:[{name:'"default"'},{name:'"border"'},{name:'"bg"'}]},defaultValue:{func:!1,value:"'default'"}},{name:"color",required:!1,type:{name:"union",elements:[{name:'"black"'},{name:'"white"'},{name:'"primary"'},{name:'"secondary"'},{name:'"accent"'}]},defaultValue:{func:!1,value:"'black'"}},{name:"size",required:!1,type:{name:"union",elements:[{name:'"sm"'},{name:'"md"'},{name:'"lg"'}]},defaultValue:{func:!1,value:"'md'"}}],slots:[{name:"default"}],sourceFiles:["/home/runner/work/Nuxt-CSS-Library-Boilerplate/Nuxt-CSS-Library-Boilerplate/src/components/Mockup/PhoneMockup.vue"]};const S={title:"Mockup/PhoneMockup",component:a,parameters:{layout:"centered",docs:{description:{component:"Mobile device mockup component for showcasing mobile apps and responsive designs."}}},argTypes:{color:{control:{type:"select"},options:["black","white","gold","silver"],description:"Phone frame color"},size:{control:{type:"select"},options:["sm","md","lg"],description:"Phone mockup size"},variant:{control:{type:"select"},options:["iphone","android","modern"],description:"Phone style variant"}},tags:["autodocs"]},l={args:{color:"black",size:"md"},render:s=>({components:{PhoneMockup:a},setup(){return{args:s}},template:`
    ...
    `})},n={args:{color:"white",size:"lg"},render:s=>({components:{PhoneMockup:a},setup(){return{args:s}},template:`
      <PhoneMockup v-bind="args">
    ...
    `})},i={args:{color:"black",size:"md"},render:s=>({components:{PhoneMockup:a},setup(){return{args:s}},template:`
      <PhoneMockup v-bind="args">
    ...
    `})},o={args:{color:"white",size:"md"},render:s=>({components:{PhoneMockup:a},setup(){return{args:s}},template:`
      <PhoneMockup v-bind="args">
        <div class="bg-white h-full flex flex-col">
          <!-- Header -->
