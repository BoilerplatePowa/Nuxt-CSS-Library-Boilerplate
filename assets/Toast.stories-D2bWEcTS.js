import{T as o,a as h,u as x}from"./useToast-nni2Z9iW.js";import"./iframe-D8bQcoLX.js";import"./preload-helper-D9Z9MdNV.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const P={title:"Feedback/Toast",component:o,parameters:{layout:"centered",docs:{description:{component:"Toast notification component for displaying temporary messages and alerts."}}},argTypes:{message:{control:"text",description:"Toast message content"},type:{control:{type:"select"},options:["info","success","warning","error"],description:"Toast variant determining color and icon"},duration:{control:{type:"number",min:1e3,max:1e4,step:500},description:"Auto-dismiss duration in milliseconds"},title:{control:"text",description:"Toast title"},closable:{control:"boolean",description:"Show close button"},persistent:{control:"boolean",description:"Prevent auto-dismiss"},position:{control:{type:"select"},options:["top-right","top-left","bottom-right","bottom-left","top-center","bottom-center"],description:"Toast position on screen (only works when fixed is true)"},fixed:{control:"boolean",description:"Use fixed positioning (required for position prop to work)"}},tags:["autodocs"]},a={args:{message:"This is a default toast message",type:"info",closable:!0}},i={render:()=>({components:{Toast:o},data(){return{toasts:[{id:1,message:"Information message",type:"info"},{id:2,message:"Success! Operation completed",type:"success"},{id:3,message:"Warning: Please check your input",type:"warning"},{id:4,message:"Error: Something went wrong",type:"error"}]}},template:`
      <div class="space-y-4">
        <Toast 
    ...
    `})},r={render:()=>({components:{Toast:o},template:`
      <div class="space-y-4">
        <Toast 
    ...
    `})},l={render:()=>({components:{Toast:o},template:`
      <div class="space-y-4">
        <Toast 
          type="info"
          :closable="true"
    ...
    `})},c={render:()=>({components:{Toast:o},data(){return{toasts:[],nextId:1}},methods:{addToast(t,e){const s={id:this.nextId++,type:t,message:e,timestamp:new Date};this.toasts.push(s),setTimeout(()=>{this.removeToast(s.id)},3e3)},removeToast(t){const e=this.toasts.findIndex(s=>s.id===t);e>-1&&this.toasts.splice(e,1)}},template:`
      <div>
    ...
    `})},d={render:()=>({components:{Toast:o},data(){return{currentPosition:0,positions:[{key:"top-left",label:"Top Left",type:"info"},{key:"top-center",label:"Top Center",type:"success"},{key:"top-right",label:"Top Right",type:"warning"},{key:"bottom-left",label:"Bottom Left",type:"error"},{key:"bottom-center",label:"Bottom Center",type:"info"},{key:"bottom-right",label:"Bottom Right",type:"success"}]}},methods:{nextPosition(){this.currentPosition=(this.currentPosition+1)%this.positions.length},prevPosition(){this.currentPosition=this.currentPosition===0?this.positions.length-1:this.currentPosition-1}},computed:{activePosition(){return this.positions[this.currentPosition]}},template:`
      <div class="space-y-6">
    ...
    `})},p={render:()=>({components:{Toast:o},template:`
      <div class="space-y-6">
        <div class="text-center">
    ...
    `})},m={render:()=>({components:{Toast:o},data(){return{activeToasts:[],nextId:1,positions:[{key:"top-left",label:"Top Left",type:"info"},{key:"top-center",label:"Top Center",type:"success"},{key:"top-right",label:"Top Right",type:"warning"},{key:"bottom-left",label:"Bottom Left",type:"error"},{key:"bottom-center",label:"Bottom Center",type:"info"},{key:"bottom-right",label:"Bottom Right",type:"success"}]}},methods:{showToast(t,e,s){const n={id:this.nextId++,position:t,type:e,message:`${s} toast notification!`,timestamp:new Date};this.activeToasts.push(n),setTimeout(()=>{this.removeToast(n.id)},3e3)},removeToast(t){const e=this.activeToasts.findIndex(s=>s.id===t);e>-1&&this.activeToasts.splice(e,1)}},template:`
      <div>
    ...
    `})},b={render:()=>({components:{Toast:o,ToastContainer:h},setup(){const{toasts:t,addToast:e,removeToast:s,success:n,error:v,warning:g,info:f}=x();return{toasts:t,addToast:e,removeToast:s,success:n,error:v,warning:g,info:f}},template:`
      <div>
    ...
    `})},u={render:()=>({components:{Toast:o},data(){return{progress:0,isUploading:!1}},methods:{startUpload(){this.isUploading=!0,this.progress=0;const t=setInterval(()=>{this.progress+=Math.random()*15,this.progress>=100&&(this.progress=100,this.isUploading=!1,clearInterval(t))},200)}},template:`
      <div>
        <button 
          @click="startUpload"
...
}`,...u.parameters?.docs?.source}}};const S=["Default","Variants","WithActions","RichContent","ToastManager","Positions","AllPositions","PositionDemo","StackingDemo","ProgressToast"];export{p as AllPositions,a as Default,m as PositionDemo,d as Positions,u as ProgressToast,l as RichContent,b as StackingDemo,c as ToastManager,i as Variants,r as WithActions,S as __namedExportsOrder,P as default};
