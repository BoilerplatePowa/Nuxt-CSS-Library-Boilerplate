import{_ as t}from"./StatusBox-QfjbNVM6.js";import"./iframe-B8bctOEb.js";import"./preload-helper-D9Z9MdNV.js";import"./Status-C0hKYmW5.js";const f={title:"Data Display/StatusBox",component:t,parameters:{layout:"centered"},argTypes:{variant:{control:{type:"select"},options:["success","error","warning","info","pending","neutral"]},size:{control:{type:"select"},options:["sm","md","lg"]},showIndicator:{control:{type:"boolean"}},dismissible:{control:{type:"boolean"}}}},s={args:{variant:"success",title:"Success",message:"Your action completed successfully."}},a={render:()=>({components:{StatusBox:t},template:`
    ...
    `})},n={render:()=>({components:{StatusBox:t},template:`
      <div class="space-y-4">
        <div>
    ...
    `})},o={render:()=>({components:{StatusBox:t},data(){return{now:new Date,fiveMinutesAgo:new Date(Date.now()-300*1e3),oneHourAgo:new Date(Date.now()-3600*1e3),yesterdayDate:new Date(Date.now()-1440*60*1e3)}},template:`
    ...
    `})},c={render:()=>({components:{StatusBox:t},template:`
      <div class="space-y-4 max-w-lg">
...
}`,...m.parameters?.docs?.source}}};const b=["Default","Variants","Sizes","WithTimestamp","WithActions","Dismissible","CustomIndicators","NotificationCenter"];export{c as CustomIndicators,s as Default,l as Dismissible,m as NotificationCenter,n as Sizes,a as Variants,r as WithActions,o as WithTimestamp,b as __namedExportsOrder,f as default};
