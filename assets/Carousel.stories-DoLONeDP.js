import{_ as y}from"./Carousel-CcbopqOG.js";import"./iframe-DKx4txre.js";import"./preload-helper-D9Z9MdNV.js";const C={title:"Data Display/Carousel",component:y,parameters:{layout:"centered",docs:{description:{component:"Interactive carousel component for displaying images and content with flexible navigation controls. Supports multiple arrow positions (bottom, sides), pagination types (numbers, dots, line), and style variants for both indicators and arrows. Side arrows are transparent by default and appear on hover."}}},argTypes:{items:{control:"object",description:"Array of carousel items"},autoplay:{control:"boolean",description:"Enable automatic slide progression"},autoplayInterval:{control:{type:"number",min:1e3,max:1e4,step:500},description:"Autoplay interval in milliseconds"},showIndicators:{control:"boolean",description:"Show dot indicators"},showArrows:{control:"boolean",description:"Show navigation arrows"},loop:{control:"boolean",description:"Enable infinite loop"},variant:{control:{type:"select"},options:["default","full-width","center","vertical"],description:"Carousel variant"},controllerPosition:{control:{type:"select"},options:["bottom","sides"],description:"Position of navigation arrows"},paginationType:{control:{type:"select"},options:["numbers","dots","line","default"],description:"Type of pagination indicators"},indicatorVariant:{control:{type:"select"},options:["default","filled","outline","ghost","link"],description:"Style variant for pagination indicators"},arrowVariant:{control:{type:"select"},options:["default","filled","outline","ghost","link","glass"],description:"Style variant for arrow buttons"}},tags:["autodocs"]},e=[{image:"https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800&h=400&fit=crop",alt:"Mountain landscape",value:"1"},{image:"https://images.unsplash.com/photo-1518837695005-2083093ee35b?w=800&h=400&fit=crop",alt:"Ocean waves",value:"2"},{image:"https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=800&h=400&fit=crop",alt:"Forest path",value:"3"},{image:"https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800&h=400&fit=crop",alt:"Desert dunes",value:"4"}],t={args:{items:e,controllerPosition:"bottom",paginationType:"dots",showIndicators:!0,showArrows:!0}},r={args:{items:e,autoplay:!0,autoplayInterval:3e3,showIndicators:!0,showArrows:!0}},s={args:{items:e,showIndicators:!1,showArrows:!1}},o={args:{items:e,controllerPosition:"sides",showIndicators:!0,showArrows:!0},parameters:{docs:{description:{story:"Side arrows are transparent by default and appear when hovering over the carousel. They span the full height of the carousel."}}}},a={args:{items:e,paginationType:"numbers",showIndicators:!0,showArrows:!0}},n={args:{items:e,paginationType:"dots",showIndicators:!0,showArrows:!0}},i={args:{items:e,paginationType:"line",showIndicators:!0,showArrows:!0}},l={args:{items:e,loop:!0,showIndicators:!0,showArrows:!0}},c={args:{items:[{value:"1",content:`
        ...
        `}],showIndicators:!0,showArrows:!0}},d={args:{items:[{value:"1",content:`
          <div class="flex flex-col items-center p-8 bg-gradient-to-br from-blue-50 to-indigo-100">
            <div class="w-32 h-32 bg-blue-500 rounded-full mb-4 flex items-center justify-center text-white text-4xl">
              📱
            </div>
        ...
        `}],autoplay:!0,autoplayInterval:4e3,showIndicators:!0,showArrows:!1}},u={args:{items:e,indicatorVariant:"filled",showIndicators:!0,showArrows:!0},parameters:{docs:{description:{story:"Carousel with filled indicator style - active indicators are primary colored, inactive ones are base-200."}}}},p={args:{items:e,indicatorVariant:"outline",showIndicators:!0,showArrows:!0},parameters:{docs:{description:{story:"Carousel with outline indicator style - all indicators have outlines, active ones are primary colored."}}}},h={args:{items:e,indicatorVariant:"ghost",showIndicators:!0,showArrows:!0},parameters:{docs:{description:{story:"Carousel with ghost indicator style - subtle indicators that become primary colored when active."}}}},w={args:{items:e,indicatorVariant:"link",showIndicators:!0,showArrows:!0},parameters:{docs:{description:{story:"Carousel with link indicator style - indicators look like links, active ones are primary colored."}}}},g={args:{items:e,arrowVariant:"filled",showIndicators:!0,showArrows:!0},parameters:{docs:{description:{story:"Carousel with filled arrow buttons - primary colored buttons."}}}},v={args:{items:e,arrowVariant:"outline",showIndicators:!0,showArrows:!0},parameters:{docs:{description:{story:"Carousel with outline arrow buttons - outlined buttons with transparent background."}}}},x={args:{items:e,arrowVariant:"ghost",showIndicators:!0,showArrows:!0},parameters:{docs:{description:{story:"Carousel with ghost arrow buttons - subtle buttons that become more visible on hover."}}}},f={args:{items:e,arrowVariant:"glass",showIndicators:!0,showArrows:!0},parameters:{docs:{description:{story:"Carousel with glass arrow buttons - translucent buttons with blur effect."}}}},b={args:{items:e,indicatorVariant:"filled",arrowVariant:"glass",controllerPosition:"sides",showIndicators:!0,showArrows:!0},parameters:{docs:{description:{story:"Carousel combining different variants - filled indicators with glass arrows and side controls."}}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  args: {
    items: imageItems,
...
}`,...b.parameters?.docs?.source}}};const P=["Default","Autoplay","NoControls","SideControls","NumbersPagination","DotsPagination","LinePagination","InfiniteLoop","ProductShowcase","ProductShowcaseWithSideControls","TestimonialCarousel","FilledIndicators","OutlineIndicators","GhostIndicators","LinkIndicators","FilledArrows","OutlineArrows","GhostArrows","GlassArrows","CombinedVariants"];export{r as Autoplay,b as CombinedVariants,t as Default,n as DotsPagination,g as FilledArrows,u as FilledIndicators,x as GhostArrows,h as GhostIndicators,f as GlassArrows,l as InfiniteLoop,i as LinePagination,w as LinkIndicators,s as NoControls,a as NumbersPagination,v as OutlineArrows,p as OutlineIndicators,c as ProductShowcase,d as ProductShowcaseWithSideControls,o as SideControls,m as TestimonialCarousel,P as __namedExportsOrder,C as default};
