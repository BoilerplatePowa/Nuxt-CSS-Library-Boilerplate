import{r as t}from"./iframe-C1Ystuve.js";import{S as s}from"./Swap-BK9Dkth2.js";import"./preload-helper-D9Z9MdNV.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const h={title:"Actions/Swap",component:s,parameters:{layout:"centered",docs:{description:{component:"An animated swap component for toggling between two states with smooth transitions. Uses Vue 3.4+ `defineModel()` macro for seamless v-model integration with proper TypeScript support."}}},argTypes:{modelValue:{control:"boolean",description:"Current swap state (handled by v-model using defineModel macro)",table:{type:{summary:"boolean"},defaultValue:{summary:"false"},category:"v-model"}},variant:{control:{type:"select"},options:["rotate","flip","indeterminate"],description:"Swap animation variant",table:{type:{summary:"rotate | flip | indeterminate"},defaultValue:{summary:"rotate"}}},swapOnContent:{control:"text",description:"Content for on state (fallback when no slot is provided)",table:{type:{summary:"string"},defaultValue:{summary:"🌞"}}},swapOffContent:{control:"text",description:"Content for off state (fallback when no slot is provided)",table:{type:{summary:"string"},defaultValue:{summary:"🌚"}}},indeterminateContent:{control:"text",description:"Content for indeterminate state (fallback when no slot is provided)",table:{type:{summary:"string"},defaultValue:{summary:"🌤️"}}},disabled:{control:"boolean",description:"Disable the swap interaction",table:{type:{summary:"boolean"},defaultValue:{summary:"false"}}},name:{control:"text",description:"Name attribute for the input element (useful for forms)",table:{type:{summary:"string"}}},id:{control:"text",description:"ID attribute for the input element (useful for accessibility)",table:{type:{summary:"string"}}}},tags:["autodocs"]},n={args:{modelValue:!1},render:e=>({components:{Swap:s},setup(){return{isOn:t(e.modelValue),args:e}},template:`
      <div class="space-y-4">
    ...
    `})},i={render:()=>({components:{Swap:s},setup(){return{isOn:t()}},template:`
      <div class="space-y-4">
    ...
    `})},o={args:{modelValue:!1,swapOnContent:"✅",swapOffContent:"❌"},render:e=>({components:{Swap:s},setup(){return{isOn:t(e.modelValue),args:e}},template:`
      <div class="space-y-4">
    ...
    `})},d={render:()=>({components:{Swap:s},setup(){return{states:t([!1,!1,!1])}},template:`
      <div class="space-y-6">
    ...
    `})},r={render:()=>({components:{Swap:s},setup(){const e=t(!1),a=t(0),l=t("");return{isOn:e,toggleCount:a,lastToggleTime:l,handleToggle:()=>{a.value++,l.value=new Date().toLocaleTimeString()}}},template:`
      <div class="space-y-6">
    ...
    `})},m={render:()=>({components:{Swap:s},setup(){const e=t({notifications:!1,marketing:!1,darkMode:!1,autoSave:!0});return{formData:e,handleSubmit:()=>{alert("Form submitted with: "+JSON.stringify(e.value,null,2))}}},template:`
    ...
    `})},c={render:()=>({components:{Swap:s},setup(){const e=t(!1),a=t(!1);return{isOn:e,externalControl:a,toggleFromParent:()=>{e.value=!e.value},syncWithExternal:()=>{e.value=a.value}}},template:`
      <div class="space-y-6">
    ...
    `})},p={render:()=>({components:{Swap:s},setup(){return{isOn:t(!1)}},template:`
      <div class="space-y-6">
    ...
    `})},u={render:()=>({components:{Swap:s},setup(){const e=t(!1),a=t(!1),l=t(!1);return{themeValue:e,notificationsValue:a,soundValue:l}},template:`
      <div class="space-y-8">
...
}`,...u.parameters?.docs?.source}}};const w=["BasicUsage","WithDefaultValue","CustomContent","Variants","WithEventHandling","FormIntegration","ParentControl","DisabledState","Accessibility"];export{u as Accessibility,n as BasicUsage,o as CustomContent,p as DisabledState,m as FormIntegration,c as ParentControl,d as Variants,i as WithDefaultValue,r as WithEventHandling,w as __namedExportsOrder,h as default};
