import{r as i}from"./iframe--6dECDSE.js";import{_ as n}from"./Steps-DgxT3k3s.js";import{_ as h}from"./Icon-Cyg07zqG.js";import{_ as g}from"./Button-Cr1KVEgd.js";import{C as f}from"./Card-DnNTebjD.js";import{_ as x}from"./Avatar-ChVWa20J.js";import"./preload-helper-D9Z9MdNV.js";import"./x-CvlftGd-.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./Badge-Dj2vUqwU.js";import"./Status-DOHks-7U.js";const O={title:"Navigation/Steps",component:n,parameters:{layout:"padded",docs:{description:{component:`
...
The Steps component is perfect for checkout processes, form wizards, onboarding flows, and any multi-step user journey.
    ...
    `})},l={render:()=>({components:{Steps:n,Button:g,Card:f},setup(){const e=i(1);return{currentStep:e,steps:C,handleStepClick:t=>{e.value=t,console.log(`Step clicked: ${t}`)}}},template:`
    ...
    `})},p={render:()=>({components:{Steps:n,Card:f,Icon:h},setup(){const e=i(2);return{orderStep:e,orderSteps:w,handleStepClick:t=>{e.value=t,console.log(`Step clicked: ${t}`)}}},template:`
