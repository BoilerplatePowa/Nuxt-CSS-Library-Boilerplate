import{C as t}from"./Card-BhjME2fK.js";import{_ as a}from"./Button-C7ds6drX.js";import{A as N}from"./Alert-Comr1GRa.js";import{r}from"./iframe-B8bctOEb.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./Icon-CrPlXafV.js";import"./x-D8wxfldR.js";import"./preload-helper-D9Z9MdNV.js";const $={title:"Data Display/Card",component:t,parameters:{layout:"centered",docs:{description:{component:"A flexible card component with optional header, body and footer."}}},tags:["autodocs"],argTypes:{title:{control:{type:"text"},description:"Card title"},variant:{control:{type:"select"},options:["normal","bordered","compact","side","outline"],description:"Card variant"},shadow:{control:{type:"select"},options:["none","sm","md","lg","xl","2xl"],description:"Card shadow size"},glass:{control:"boolean",description:"Glass effect"},imageFull:{control:"boolean",description:"Full image layout"}}},n={render:e=>({components:{Card:t},setup(){return{args:e}},template:'<Card v-bind="args">Card content with simple text.</Card>'})},i={args:{title:"Card Title"},render:e=>({components:{Card:t},setup(){return{args:e}},template:'<Card v-bind="args">This card has a title defined via the title prop.</Card>'})},d={render:e=>({components:{Card:t},setup(){return{args:e}},template:`
      <Card v-bind="args">
        <template #header>
    ...
    `})},l={render:e=>({components:{Card:t,Button:a},setup(){return{args:e}},template:`
      <Card v-bind="args">
    ...
    `})},o={args:{variant:"bordered",title:"Bordered Card"},render:e=>({components:{Card:t},setup(){return{args:e}},template:'<Card v-bind="args">This card uses the bordered variant with a visible border.</Card>'})},c={args:{variant:"outline",title:"Outline Card"},render:e=>({components:{Card:t},setup(){return{args:e}},template:'<Card v-bind="args">This card uses the outline variant with a transparent background and prominent border.</Card>'})},p={args:{glass:!0,title:"Glass Card"},render:e=>({components:{Card:t},setup(){return{args:e}},template:`
    ...
    `})},u={args:{shadow:"none",title:"No Shadow"},render:e=>({components:{Card:t},setup(){return{args:e}},template:'<Card v-bind="args">This card has no shadow.</Card>'})},m={args:{shadow:"2xl",title:"With Shadow"},render:e=>({components:{Card:t},setup(){return{args:e}},template:'<Card v-bind="args">This card has a very pronounced shadow.</Card>'})},g={args:{variant:"compact",title:"Compact Card"},render:e=>({components:{Card:t},setup(){return{args:e}},template:'<Card v-bind="args">This card uses compact variant with reduced padding.</Card>'})},v={args:{variant:"side",title:"Side Card"},render:e=>({components:{Card:t},setup(){return{args:e}},template:'<Card v-bind="args">This card uses side layout variant.</Card>'})},b={render:e=>({components:{Card:t,Button:a},setup(){return{args:e}},template:`
    ...
    `})},h={render:()=>({components:{Card:t},template:`
    ...
    `})},C={render:()=>({components:{Card:t},template:`
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
    ...
    `})},y={render:()=>({components:{Card:t,Button:a},template:`
    ...
    `})},f={args:{variant:"outline"},render:e=>({components:{Card:t,Button:a},setup(){return{args:e}},template:`
    ...
    `})},x={args:{title:"Card with Badge",badge:"New",badgeVariant:"primary"},render:e=>({components:{Card:t},setup(){return{args:e}},template:'<Card v-bind="args">This card has a badge positioned above the title for better visual hierarchy.</Card>'})},w={render:()=>({components:{Card:t,Button:a},template:`
      <div class="space-y-4">
    ...
    `})},B={render:()=>({components:{Card:t},template:`
      <div class="space-y-4">
    ...
    `})},k={render:()=>({components:{Card:t,Button:a},template:`
      <div class="space-y-8">
    ...
    `})},T={render:()=>({components:{Card:t,Button:a},template:`
      <div class="space-y-6">
        <div class="text-center mb-6">
    ...
    `})},S={render:()=>({components:{Card:t,Button:a},template:`
      <div class="space-y-8">
        <div class="text-center mb-6">
    ...
    `})},V={render:()=>({components:{Card:t,Button:a,Alert:N},setup(){const e=r("card-1"),z=r(0),j=r(""),s=r(!1),A=r(""),G=r("info"),I=E=>{e.value=E,z.value++,j.value=E,console.log(`Card ${E} clicked! Total clicks: ${z.value}`)};return{selectedCard:e,clickCount:z,lastClicked:j,showAlert:s,alertMessage:A,alertType:G,handleCardClick:I,handleAlertCardClick:()=>{s.value=!0,A.value="This is an alert triggered by clicking the card!",G.value="success",I("alert-card"),setTimeout(()=>{s.value=!1},3e3)},handleErrorCardClick:()=>{s.value=!0,A.value="Something went wrong! This is an error alert.",G.value="error",I("error-card"),setTimeout(()=>{s.value=!1},5e3)}}},template:`
      <div class="space-y-8">
        <div class="text-center mb-6">
  ...
  render: args => ({
    ...
    template: '<Card v-bind="args">This card uses the outline variant with a transparent background and prominent border.</Card>'
  })
...
}`,...V.parameters?.docs?.source}}};const _=["Default","WithTitle","CustomHeader","WithFooter","Bordered","Outline","Glass","NoShadow","WithShadow","Compact","SideCard","ComplexCard","AllVariants","ShadowVariants","WithAllSections","OutlineWithSections","WithBadge","BadgeWithHeaderActions","CustomBadgePosition","AllCardVariants","SideVariant","GlassEffects","InteractiveCards"];export{k as AllCardVariants,h as AllVariants,w as BadgeWithHeaderActions,o as Bordered,g as Compact,b as ComplexCard,B as CustomBadgePosition,d as CustomHeader,n as Default,p as Glass,S as GlassEffects,V as InteractiveCards,u as NoShadow,c as Outline,f as OutlineWithSections,C as ShadowVariants,v as SideCard,T as SideVariant,y as WithAllSections,x as WithBadge,l as WithFooter,m as WithShadow,i as WithTitle,_ as __namedExportsOrder,$ as default};
