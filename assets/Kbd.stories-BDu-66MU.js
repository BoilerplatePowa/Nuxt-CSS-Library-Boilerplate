import{K as e}from"./Kbd-BWZGUC7r.js";import"./iframe-B8bctOEb.js";import"./preload-helper-D9Z9MdNV.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const y={title:"Data Display/Kbd",component:e,parameters:{layout:"centered",docs:{description:{component:"Keyboard key representation component for displaying keyboard shortcuts and key combinations."}}},argTypes:{keyText:{control:"text",description:"The key or key combination to display"},size:{control:{type:"select"},options:["xs","sm","md","lg"],description:"Size of the keyboard key"},variant:{control:{type:"select"},options:["default","primary","secondary","accent"],description:"Visual style variant"}},tags:["autodocs"]},s={args:{keyText:"Enter"}},n={render:()=>({components:{Kbd:e},template:`
...
}`,...p.parameters?.docs?.source}}};const b=["Default","SingleKeys","KeyCombinations","Sizes","Variants","KeyboardShortcuts","ArrowKeys","FunctionKeys","GameControls"];export{r as ArrowKeys,s as Default,c as FunctionKeys,p as GameControls,t as KeyCombinations,d as KeyboardShortcuts,n as SingleKeys,a as Sizes,i as Variants,b as __namedExportsOrder,y as default};
