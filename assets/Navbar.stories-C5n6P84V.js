import{d as w,c as x,a,o as s,m as n,e as o,b as i,t as k,n as y}from"./iframe-DxBZQA7Y.js";import{_ as N}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./preload-helper-D9Z9MdNV.js";const M={key:0,class:"navbar-start"},S={key:0,class:"dropdown"},z={tabindex:"0",class:"menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52"},L=["href"],B=["src","alt"],C={key:1},j={key:1,class:"navbar-center hidden lg:flex"},I={key:2,class:"navbar-end"},g=w({__name:"Navbar",props:{title:{},logo:{},logoAlt:{default:"Logo"},logoHref:{default:"/"},variant:{default:"default"},shadow:{type:Boolean,default:!1},showMobileMenu:{type:Boolean,default:!0}},setup(t){const b=t,f=x(()=>{const e=["navbar","bg-base-100"];return b.variant==="sticky"?e.push("sticky","top-0","z-30"):b.variant==="glass"&&e.push("glass"),b.shadow&&e.push("shadow-lg"),e.join(" ")});return(e,h)=>(s(),a("div",{class:y(f.value)},[e.$slots.start||e.logo||e.title?(s(),a("div",M,[o(e.$slots,"start",{},()=>[e.showMobileMenu?(s(),a("div",S,[h[0]||(h[0]=i("div",{tabindex:"0",role:"button",class:"btn btn-ghost lg:hidden"},[i("svg",{class:"w-5 h-5",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[i("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M4 6h16M4 12h8m-8 6h16"})])],-1)),i("ul",z,[o(e.$slots,"mobile-menu",{},void 0,!0)])])):n("",!0),e.logo||e.title?(s(),a("a",{key:1,href:e.logoHref,class:"btn btn-ghost text-xl"},[e.logo?(s(),a("img",{key:0,src:e.logo,alt:e.logoAlt,class:"h-8 w-auto"},null,8,B)):n("",!0),e.title?(s(),a("span",C,k(e.title),1)):n("",!0)],8,L)):n("",!0)],!0)])):n("",!0),e.$slots.center?(s(),a("div",j,[o(e.$slots,"center",{},void 0,!0)])):n("",!0),e.$slots.end?(s(),a("div",I,[o(e.$slots,"end",{},void 0,!0)])):n("",!0)],2))}}),l=N(g,[["__scopeId","data-v-49f97681"]]);g.__docgenInfo={exportName:"default",displayName:"Navbar",description:"",tags:{},props:[{name:"title",required:!1,type:{name:"string"}},{name:"logo",required:!1,type:{name:"string"}},{name:"logoAlt",required:!1,type:{name:"string"},defaultValue:{func:!1,value:"'Logo'"}},{name:"logoHref",required:!1,type:{name:"string"},defaultValue:{func:!1,value:"'/'"}},{name:"variant",required:!1,type:{name:"union",elements:[{name:'"default"'},{name:'"sticky"'},{name:'"glass"'}]},defaultValue:{func:!1,value:"'default'"}},{name:"shadow",required:!1,type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"showMobileMenu",required:!1,type:{name:"boolean"},defaultValue:{func:!1,value:"true"}}],slots:[{name:"start"},{name:"mobile-menu"},{name:"center"},{name:"end"}],sourceFiles:["/home/runner/work/Nuxt-CSS-Library-Boilerplate/Nuxt-CSS-Library-Boilerplate/src/components/Navigation/Navbar.vue"]};const D={title:"Navigation/Navbar",component:l,parameters:{layout:"fullscreen",docs:{description:{component:"Navigation bar component with responsive design and customizable brand, menu items, and actions."}}},argTypes:{title:{control:"text",description:"Brand title text"},logo:{control:"text",description:"Logo image URL"},logoAlt:{control:"text",description:"Logo alt text"},logoHref:{control:"text",description:"Logo link URL"},variant:{control:{type:"select"},options:["default","sticky","glass"],description:"Navbar style variant"},shadow:{control:"boolean",description:"Show navbar shadow"},showMobileMenu:{control:"boolean",description:"Show mobile hamburger menu"}},tags:["autodocs"]},v=[{label:"Home",href:"#home",active:!0},{label:"Products",href:"#products"},{label:"Solutions",href:"#solutions"},{label:"Pricing",href:"#pricing"},{label:"About",href:"#about"}],r={args:{title:"Your Brand"},render:t=>({components:{Navbar:l},setup(){return{args:t,menuItems:v}},template:`
      <Navbar v-bind="args">
        <template #menu>
    ...
    `})},d={render:t=>({components:{Navbar:l},setup(){return{args:t,menuItems:v}},template:`
      <Navbar v-bind="args">
        <template #brand>
    ...
    `}),args:{title:"Logo Brand"}},c={args:{title:"Glass Nav",variant:"glass"},render:t=>({components:{Navbar:l},setup(){return{args:t,menuItems:v}},template:`
      <div>
        <Navbar v-bind="args">
          <template #menu>
            <ul class="menu menu-horizontal px-1">
    ...
    `})},u={render:t=>({components:{Navbar:l},setup(){return{args:t,menuItems:v}},template:`
      <Navbar v-bind="args">
        <template #brand>
          <div class="flex items-center">
    ...
    `}),args:{title:"Responsive Nav"}},m={render:t=>({components:{Navbar:l},setup(){return{args:t}},template:`
      <Navbar v-bind="args">
        <template #brand>
          <div class="flex items-center">
    ...
    `}),args:{title:"ShopMart"}},p={render:t=>({components:{Navbar:l},setup(){return{args:t}},template:`
      <Navbar v-bind="args">
        <template #brand>
          <div class="flex items-center">
...
}`,...p.parameters?.docs?.source}}};const _=["Default","WithLogo","Glass","Responsive","ECommerce","Dashboard"];export{p as Dashboard,r as Default,m as ECommerce,c as Glass,u as Responsive,d as WithLogo,_ as __namedExportsOrder,D as default};
