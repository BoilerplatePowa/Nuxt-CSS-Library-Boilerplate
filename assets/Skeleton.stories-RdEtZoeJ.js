import{d as m,c as h,a as u,e as k,y as S,n as g,o as f}from"./iframe-Cy2SohGF.js";import{_ as w}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./preload-helper-D9Z9MdNV.js";const c=m({__name:"Skeleton",props:{variant:{default:"text"},width:{},height:{},lines:{default:1},animated:{type:Boolean,default:!0}},setup(p){const e=p,v=h(()=>{const t=["skeleton"];return e.variant==="text"?t.push("skeleton-text"):e.variant==="circular"?t.push("skeleton-circular"):e.variant==="rectangular"?t.push("skeleton-rectangular"):e.variant==="rounded"&&t.push("skeleton-rounded"),e.animated||t.push("skeleton-no-animation"),t.join(" ")}),x=h(()=>{const t={};return e.width&&(t.width=typeof e.width=="number"?`${e.width}px`:e.width),e.height&&(t.height=typeof e.height=="number"?`${e.height}px`:e.height),t});return(t,b)=>(f(),u("div",{class:g(v.value),style:S(x.value)},[k(t.$slots,"default",{},void 0,!0)],6))}}),n=w(c,[["__scopeId","data-v-fd0ff5c9"]]);c.__docgenInfo={exportName:"default",displayName:"Skeleton",description:"",tags:{},props:[{name:"variant",required:!1,type:{name:"union",elements:[{name:'"text"'},{name:'"circular"'},{name:'"rectangular"'},{name:'"rounded"'}]},defaultValue:{func:!1,value:"'text'"}},{name:"width",required:!1,type:{name:"union",elements:[{name:"string"},{name:"number"}]}},{name:"height",required:!1,type:{name:"union",elements:[{name:"string"},{name:"number"}]}},{name:"lines",required:!1,type:{name:"number"},defaultValue:{func:!1,value:"1"}},{name:"animated",required:!1,type:{name:"boolean"},defaultValue:{func:!1,value:"true"}}],slots:[{name:"default"}],sourceFiles:["/home/runner/work/Nuxt-CSS-Library-Boilerplate/Nuxt-CSS-Library-Boilerplate/src/components/Feedback/Skeleton.vue"]};const C={title:"Feedback/Skeleton",component:n,parameters:{layout:"padded"},argTypes:{variant:{control:{type:"select"},options:["text","circular","rectangular","rounded"]},width:{control:{type:"text"}},height:{control:{type:"text"}},lines:{control:{type:"number"}},animated:{control:{type:"boolean"}}}},a={args:{variant:"text",width:"100%"}},i={render:()=>({components:{Skeleton:n},template:`
      <div class="space-y-8">
        <div>
