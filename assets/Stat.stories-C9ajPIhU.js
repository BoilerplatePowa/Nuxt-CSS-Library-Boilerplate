import{S as t}from"./Stat-_wlrXnhC.js";import"./iframe-BEoDMSxF.js";import"./preload-helper-D9Z9MdNV.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const v={title:"DataDisplay/Stat",component:t,parameters:{layout:"padded"},argTypes:{variant:{control:{type:"select"},options:["default","bordered","compact"]},valueColor:{control:{type:"select"},options:["default","primary","secondary","accent","info","success","warning","error"]},size:{control:{type:"select"},options:["sm","md","lg"]}}},e={args:{title:"Total Sales",value:"12,345",description:"↗︎ 400 (22%)",icon:"💰"}},n={render:()=>({components:{Stat:t},template:`
    ...
    `})},a={render:()=>({components:{Stat:t},template:`
    ...
    `})},s={render:()=>({components:{Stat:t},template:`
      <div class="space-y-8">
        <div>
    ...
    `})},o={render:()=>({components:{Stat:t},template:`
      <div class="space-y-6">
        <!-- Top Row Stats -->
    ...
    `})},r={render:()=>({components:{Stat:t},template:`
      <div class="stats shadow">
        <Stat 
          title="Primary"
          value="1,234"
...
}`,...r.parameters?.docs?.source}}};const p=["Default","BasicStats","WithTrends","Variants","Dashboard","CustomColors"];export{n as BasicStats,r as CustomColors,o as Dashboard,e as Default,s as Variants,a as WithTrends,p as __namedExportsOrder,v as default};
