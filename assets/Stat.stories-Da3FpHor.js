import{S as t}from"./Stat-CIHqsw3_.js";import"./iframe--6dECDSE.js";import"./preload-helper-D9Z9MdNV.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const v={title:"Data Display/Stat",component:t,parameters:{layout:"padded"},argTypes:{variant:{control:{type:"select"},options:["default","primary","secondary","accent","info","success","warning","error"]},size:{control:{type:"select"},options:["sm","md","lg"]}}},e={args:{title:"Total Sales",value:"12,345",description:"↗︎ 400 (22%)",icon:"💰"}},n={render:()=>({components:{Stat:t},template:`
