import{C as e}from"./Collapse-tMO5G4jG.js";import"./iframe-DKx4txre.js";import"./preload-helper-D9Z9MdNV.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const v={title:"Data Display/Collapse",component:e,parameters:{layout:"centered",docs:{description:{component:"Expandable content container with smooth animations and customizable styling."}}},argTypes:{title:{control:"text",description:"Title displayed in the collapse header"},modelValue:{control:"boolean",description:"Whether the collapse is open by default"},forceOpen:{control:"boolean",description:"Force the collapse to stay open"},disabled:{control:"boolean",description:"Disable the collapse interaction"},variant:{control:{type:"select"},options:["default","arrow","plus","bordered","ghost"],description:"Visual style variant"}},tags:["autodocs"]},a={args:{title:"Click to expand",modelValue:!1},render:s=>({components:{Collapse:e},setup(){return{args:s}},template:`
    ...
    `})},n={render:()=>({components:{Collapse:e},template:`
    ...
    `})},o={args:{title:"📊 Project Statistics",modelValue:!0},render:s=>({components:{Collapse:e},setup(){return{args:s}},template:`
      <div class="w-96">
        <Collapse v-bind="args">
          <div class="space-y-4">
    ...
    `})},i={render:()=>({components:{Collapse:e},template:`
    ...
    `})},r={args:{title:"This collapse is disabled",disabled:!0},render:s=>({components:{Collapse:e},setup(){return{args:s}},template:`
      <div class="w-96">
        <Collapse v-bind="args">
...
}`,...r.parameters?.docs?.source}}};const m=["Default","OpenByDefault","Variants","NestedCollapses","WithRichContent","FAQ","Disabled"];export{a as Default,r as Disabled,i as FAQ,l as NestedCollapses,t as OpenByDefault,n as Variants,o as WithRichContent,m as __namedExportsOrder,v as default};
