import{d as X,l as d,b as t,w as Y,p as T,q as D,o as c,s as K,v as R,e as M,f as v,x as W,u as h,n,j as u,y as G,g as O,t as J,T as Q,z as U}from"./vue.esm-bundler-D0HQYiut.js";import{_ as Z}from"./_plugin-vue_export-helper-DlAUqK2U.js";import{B as p}from"./Button-DXCMznbP.js";const ee=["aria-labelledby","aria-describedby"],oe=["id"],le=["id"],S=X({__name:"Modal",props:{modelValue:{type:Boolean},title:{},size:{default:"md"},closable:{type:Boolean,default:!0},closeOnOverlay:{type:Boolean,default:!0},closeOnEsc:{type:Boolean,default:!0},persistent:{type:Boolean,default:!1}},emits:["update:modelValue","close","open","escape"],setup(l,{emit:e}){let s=0;const a=()=>`modal-${++s}`,i=l,m=e,x=d(),C=a(),z=a(),E=t(()=>["fixed","inset-0","z-50","flex","items-center","justify-center","bg-black","bg-opacity-50","backdrop-blur-sm"]),V=t(()=>{const o=["modal-box","bg-white","rounded-lg","shadow-xl","max-h-[90vh]","overflow-hidden","flex","flex-col"];switch(i.size){case"sm":o.push("max-w-sm");break;case"md":o.push("max-w-md");break;case"lg":o.push("max-w-lg");break;case"xl":o.push("max-w-xl");break;case"full":o.push("max-w-full","w-full","h-full","m-4");break}return o.join(" ")}),L=t(()=>["flex","items-center","justify-between","p-6","border-b","border-gray-200"]),_=t(()=>["text-lg","font-semibold","text-gray-900"]),F=t(()=>["p-1","text-gray-400","hover:text-gray-600","transition-colors","duration-200"]),P=t(()=>["flex-1","p-6","overflow-y-auto"]),j=t(()=>["flex","items-center","justify-end","gap-3","p-6","border-t","border-gray-200"]),w=()=>{i.persistent||(m("update:modelValue",!1),m("close"))},q=()=>{i.closeOnOverlay&&w()},H=()=>{i.closeOnEsc&&(m("escape"),w())},A=()=>{document.body.style.overflow="hidden"},N=()=>{T(()=>{x.value?.focus()}),m("open")},$=()=>{document.body.style.overflow=""},I=()=>{};return Y(()=>i.modelValue,o=>{o&&T(()=>{x.value?.focus()})}),(o,f)=>(c(),D(U,{to:"body"},[K(Q,{name:"modal",onEnter:A,onAfterEnter:N,onLeave:$,onAfterLeave:I},{default:R(()=>[o.modelValue?(c(),M("div",{key:0,class:n(E.value),role:"dialog","aria-modal":!0,"aria-labelledby":h(C),"aria-describedby":h(z),onClick:q,onKeydown:W(H,["esc"])},[u("div",{ref_key:"modalRef",ref:x,class:n(V.value),onClick:f[0]||(f[0]=G(()=>{},["stop"]))},[o.$slots.header||o.title?(c(),M("header",{key:0,class:n(L.value)},[O(o.$slots,"header",{},()=>[u("h2",{id:h(C),class:n(_.value)},J(o.title),11,oe)],!0),o.closable?(c(),M("button",{key:0,type:"button",class:n(F.value),"aria-label":"Close modal",onClick:w},f[1]||(f[1]=[u("svg",{class:"w-6 h-6",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[u("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M6 18L18 6M6 6l12 12"})],-1)]),2)):v("",!0)],2)):v("",!0),u("div",{id:h(z),class:n(P.value)},[O(o.$slots,"default",{},void 0,!0)],10,le),o.$slots.footer?(c(),M("footer",{key:1,class:n(j.value)},[O(o.$slots,"footer",{},void 0,!0)],2)):v("",!0)],2)],42,ee)):v("",!0)]),_:3})]))}}),r=Z(S,[["__scopeId","data-v-58a05ae8"]]);S.__docgenInfo={exportName:"default",displayName:"Modal",description:"",tags:{},props:[{name:"modelValue",required:!0,type:{name:"boolean"}},{name:"title",required:!1,type:{name:"string"}},{name:"size",required:!1,type:{name:"union",elements:[{name:'"sm"'},{name:'"md"'},{name:'"lg"'},{name:'"xl"'},{name:'"full"'}]},defaultValue:{func:!1,value:"'md'"}},{name:"closable",required:!1,type:{name:"boolean"},defaultValue:{func:!1,value:"true"}},{name:"closeOnOverlay",required:!1,type:{name:"boolean"},defaultValue:{func:!1,value:"true"}},{name:"closeOnEsc",required:!1,type:{name:"boolean"},defaultValue:{func:!1,value:"true"}},{name:"persistent",required:!1,type:{name:"boolean"},defaultValue:{func:!1,value:"false"}}],events:[{name:"update:modelValue",type:{names:["boolean"]}},{name:"close"},{name:"open"},{name:"escape"}],slots:[{name:"header"},{name:"default"},{name:"footer"}],sourceFiles:["/home/runner/work/Nuxt-CSS-Library-Boilerplate/Nuxt-CSS-Library-Boilerplate/src/components/Modal.vue"]};const se={title:"Components/Modal",component:r,parameters:{layout:"centered",docs:{description:{component:"A flexible modal component with accessibility features, keyboard navigation, and customizable sizes."}}},tags:["autodocs"],argTypes:{size:{control:{type:"select"},options:["sm","md","lg","xl","full"],description:"Modal size"},title:{control:{type:"text"},description:"Modal title"},closable:{control:{type:"boolean"},description:"Show close button"},closeOnOverlay:{control:{type:"boolean"},description:"Close when clicking overlay"},closeOnEsc:{control:{type:"boolean"},description:"Close when pressing Escape"},persistent:{control:{type:"boolean"},description:"Prevent closing"}}},g={render:l=>({components:{Modal:r,Button:p},setup(){const e=d(!1);return{args:l,isOpen:e,openModal:()=>{e.value=!0},closeModal:()=>{e.value=!1}}},template:`
      <div>
...
}`,...k.parameters?.docs?.source}}};const de=["Default","WithFooter","CustomHeader","Sizes","Persistent"];export{y as CustomHeader,g as Default,k as Persistent,B as Sizes,b as WithFooter,de as __namedExportsOrder,se as default};
