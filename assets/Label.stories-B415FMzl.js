import{d as h,c as y,j as L,p as g,n as k,A as S,o as c,e as d,a as m,l as u,t as b}from"./iframe-B8bctOEb.js";import{_ as w}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./preload-helper-D9Z9MdNV.js";const z={key:0,class:"label-text"},C={key:1,class:"label-text-alt"},x=h({__name:"Label",props:{text:{},altText:{},htmlFor:{},tag:{default:"label"},required:{type:Boolean},cursor:{default:"default"},size:{default:"md"}},setup(v){const t=v,f=y(()=>{const e=["label"];return t.cursor==="pointer"?e.push("cursor-pointer"):t.cursor==="not-allowed"&&e.push("cursor-not-allowed"),t.size==="sm"?e.push("text-sm"):t.size==="lg"&&e.push("text-lg"),e.join(" ")});return(e,E)=>(c(),L(S(e.tag),{class:k(f.value),for:e.htmlFor},{default:g(()=>[d(e.$slots,"start",{},void 0,!0),e.text?(c(),m("span",z,b(e.text),1)):u("",!0),d(e.$slots,"default",{},void 0,!0),e.altText?(c(),m("span",C,b(e.altText),1)):u("",!0),d(e.$slots,"end",{},void 0,!0)]),_:3},8,["class","for"]))}}),a=w(x,[["__scopeId","data-v-faf7f96c"]]);x.__docgenInfo={exportName:"default",displayName:"Label",description:"",tags:{},props:[{name:"text",required:!1,type:{name:"string"}},{name:"altText",required:!1,type:{name:"string"}},{name:"htmlFor",required:!1,type:{name:"string"}},{name:"tag",required:!1,type:{name:"union",elements:[{name:'"label"'},{name:'"div"'},{name:'"span"'}]},defaultValue:{func:!1,value:"'label'"}},{name:"required",required:!1,type:{name:"boolean"}},{name:"cursor",required:!1,type:{name:"union",elements:[{name:'"default"'},{name:'"pointer"'},{name:'"not-allowed"'}]},defaultValue:{func:!1,value:"'default'"}},{name:"size",required:!1,type:{name:"union",elements:[{name:'"sm"'},{name:'"md"'},{name:'"lg"'}]},defaultValue:{func:!1,value:"'md'"}}],slots:[{name:"start"},{name:"default"},{name:"end"}],sourceFiles:["/home/runner/work/Nuxt-CSS-Library-Boilerplate/Nuxt-CSS-Library-Boilerplate/src/components/DataInput/Label.vue"]};const B={title:"Data Input/Label",component:a,parameters:{layout:"padded"},argTypes:{tag:{control:{type:"select"},options:["label","div","span"]},cursor:{control:{type:"select"},options:["default","pointer","not-allowed"]},size:{control:{type:"select"},options:["sm","md","lg"]},required:{control:{type:"boolean"}}}},n={args:{text:"Default Label"}},s={args:{text:"Email address",altText:"Required"}},l={render:()=>({components:{Label:a},template:`
