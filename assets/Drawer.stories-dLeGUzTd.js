import{d as P,r as L,w as f,c as v,a as x,y as A,b as t,z as q,u as h,e as y,n as g,m as j,o as D}from"./iframe-DKx4txre.js";import{_ as E}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./preload-helper-D9Z9MdNV.js";const R=["id"],U={class:"drawer-content"},I={class:"p-4"},z=["for"],H=["for"],F={key:0,class:"flex justify-end p-4"},k=P({__name:"Drawer",props:{modelValue:{type:Boolean,default:!1},position:{default:"left"},width:{default:"md"},backdrop:{type:Boolean,default:!0},persistent:{type:Boolean,default:!1},showCloseButton:{type:Boolean,default:!0},id:{default:void 0}},emits:["update:modelValue","open","close"],setup(C,{emit:S}){const M=()=>`drawer-${Math.random().toString(36).substr(2,9)}`,a=C,u=S,b=a.id||M(),n=L(a.modelValue);f(()=>a.modelValue,e=>{n.value=e}),f(n,e=>{u("update:modelValue",e),u(e?"open":"close")});const V=v(()=>{const e=[];return a.position==="right"&&e.push("drawer-end"),e.join(" ")}),_=v(()=>{const e=[];return a.position==="right"&&e.push("drawer-side-right"),e.join(" ")}),B=v(()=>{const e=["bg-base-200","text-base-content","min-h-full"];return a.width==="sm"?e.push("w-64"):a.width==="md"?e.push("w-80"):a.width==="lg"?e.push("w-96"):a.width==="xl"?e.push("w-[28rem]"):a.width==="full"&&e.push("w-full"),e.join(" ")}),w=()=>{n.value=!n.value},O=()=>{n.value=!0},l=()=>{a.persistent||(n.value=!1)},N=e=>{e.key==="Escape"&&n.value&&!a.persistent&&l()};return typeof window<"u"&&window.addEventListener("keydown",N),(e,o)=>(D(),x("div",{class:g(["drawer",V.value])},[A(t("input",{id:h(b),"onUpdate:modelValue":o[0]||(o[0]=T=>n.value=T),type:"checkbox",class:"drawer-toggle"},null,8,R),[[q,n.value]]),t("div",U,[y(e.$slots,"content",{toggle:w,open:O,close:l},()=>[t("div",I,[t("label",{for:h(b),class:"btn btn-primary drawer-button",onClick:w}," Open drawer ",8,z)])],!0)]),t("div",{class:g(["drawer-side",_.value])},[t("label",{for:h(b),class:"drawer-overlay",onClick:l},null,8,H),t("aside",{class:g(B.value)},[e.showCloseButton?(D(),x("div",F,[t("button",{class:"btn btn-sm btn-circle btn-ghost",onClick:l}," ✕ ")])):j("",!0),y(e.$slots,"drawer",{close:l},()=>[o[1]||(o[1]=t("div",{class:"p-4"},[t("h3",{class:"text-lg font-bold mb-4"},"Drawer Content"),t("ul",{class:"menu"},[t("li",null,[t("a",null,"Sidebar Item 1")]),t("li",null,[t("a",null,"Sidebar Item 2")])])],-1))],!0)],2)],2)],2))}}),s=E(k,[["__scopeId","data-v-49325c33"]]);k.__docgenInfo={exportName:"default",displayName:"Drawer",description:"",tags:{},props:[{name:"modelValue",required:!1,type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"position",required:!1,type:{name:"union",elements:[{name:'"left"'},{name:'"right"'},{name:'"top"'},{name:'"bottom"'}]},defaultValue:{func:!1,value:"'left'"}},{name:"width",required:!1,type:{name:"union",elements:[{name:'"sm"'},{name:'"md"'},{name:'"lg"'},{name:'"xl"'},{name:'"full"'}]},defaultValue:{func:!1,value:"'md'"}},{name:"backdrop",required:!1,type:{name:"boolean"},defaultValue:{func:!1,value:"true"}},{name:"persistent",required:!1,type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"showCloseButton",required:!1,type:{name:"boolean"},defaultValue:{func:!1,value:"true"}},{name:"id",required:!1,type:{name:"string"},defaultValue:{func:!1,value:"undefined"}}],events:[{name:"update:modelValue",type:{names:["boolean"]}},{name:"open"},{name:"close"}],slots:[{name:"content",scoped:!0,bindings:[{name:"toggle",title:"binding"},{name:"open",title:"binding"},{name:"close",title:"binding"}]},{name:"drawer",scoped:!0,bindings:[{name:"close",title:"binding"}]}],sourceFiles:["/home/runner/work/Nuxt-CSS-Library-Boilerplate/Nuxt-CSS-Library-Boilerplate/src/components/Layout/Drawer.vue"]};const W={title:"Layout/Drawer",component:s,parameters:{layout:"fullscreen"},argTypes:{position:{control:{type:"select"},options:["left","right","top","bottom"]},variant:{control:{type:"select"},options:["default","mobile","overlay"]},showCloseButton:{control:{type:"boolean"}},persistent:{control:{type:"boolean"}},modelValue:{control:{type:"boolean"}}}},r={render:()=>({components:{Drawer:s},template:`
      <div class="h-screen">
        <Drawer>
...
}`,...m.parameters?.docs?.source}}};const K=["Default","RightSide","WithCloseButton","MobileVariant","OverlayVariant","Persistent"];export{r as Default,d as MobileVariant,p as OverlayVariant,m as Persistent,i as RightSide,c as WithCloseButton,K as __namedExportsOrder,W as default};
