import{r as t}from"./iframe-BHDwIEoY.js";import{S as s}from"./Swap-Dfw5K-hL.js";import"./preload-helper-D9Z9MdNV.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const h={title:"Actions/Swap",component:s,parameters:{layout:"centered",docs:{description:{component:"An animated swap component for toggling between two states with smooth transitions. Uses Vue 3.4+ `defineModel()` macro for seamless v-model integration with proper TypeScript support."}}},argTypes:{modelValue:{control:"boolean",description:"Current swap state (handled by v-model using defineModel macro)",table:{type:{summary:"boolean"},defaultValue:{summary:"false"},category:"v-model"}},variant:{control:{type:"select"},options:["rotate","flip","indeterminate"],description:"Swap animation variant",table:{type:{summary:"rotate | flip | indeterminate"},defaultValue:{summary:"rotate"}}},swapOnContent:{control:"text",description:"Content for on state (fallback when no slot is provided)",table:{type:{summary:"string"},defaultValue:{summary:"🌞"}}},swapOffContent:{control:"text",description:"Content for off state (fallback when no slot is provided)",table:{type:{summary:"string"},defaultValue:{summary:"🌚"}}},indeterminateContent:{control:"text",description:"Content for indeterminate state (fallback when no slot is provided)",table:{type:{summary:"string"},defaultValue:{summary:"🌤️"}}},disabled:{control:"boolean",description:"Disable the swap interaction",table:{type:{summary:"boolean"},defaultValue:{summary:"false"}}},name:{control:"text",description:"Name attribute for the input element (useful for forms)",table:{type:{summary:"string"}}},id:{control:"text",description:"ID attribute for the input element (useful for accessibility)",table:{type:{summary:"string"}}}},tags:["autodocs"]},n={args:{modelValue:!1},render:e=>({components:{Swap:s},setup(){return{isOn:t(e.modelValue)}},template:`
    ...
    `})},o={args:{modelValue:!1,swapOnContent:"✅",swapOffContent:"❌"},render:e=>({components:{Swap:s},setup(){return{isOn:t(e.modelValue)}},template:`
      <div class="space-y-4">
