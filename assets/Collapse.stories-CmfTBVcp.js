import{r as d}from"./iframe-B8bctOEb.js";import{C as e}from"./Collapse-D76EfB9f.js";import"./preload-helper-D9Z9MdNV.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const b={title:"Data Display/Collapse",component:e,parameters:{layout:"centered",docs:{description:{component:"Expandable content container with smooth animations and customizable styling. Uses Vue 3.4 defineModel for v-model support."}}},argTypes:{title:{control:"text",description:"Title displayed in the collapse header"},modelValue:{control:"boolean",description:"Whether the collapse is open (v-model)"},forceOpen:{control:"boolean",description:"Force the collapse to stay open"},disabled:{control:"boolean",description:"Disable the collapse interaction"},variant:{control:{type:"select"},options:["default","arrow","plus","bordered","ghost"],description:"Visual style variant"}},tags:["autodocs"]},a={args:{title:"Click to expand",modelValue:!1},render:s=>({components:{Collapse:e},setup(){return{args:s}},template:`
      <div class="w-96">
    ...
    `})},t={args:{title:"This is open by default",modelValue:!0},render:s=>({components:{Collapse:e},setup(){return{args:s}},template:`
      <div class="w-96">
        <Collapse v-bind="args">
          <div class="space-y-4">
    ...
    `})},n={render:()=>({components:{Collapse:e},setup(){return{isOpen:d(!1)}},template:`
...
}`,...p.parameters?.docs?.source}}};const g=["Default","OpenByDefault","ReactiveVModel","Variants","NestedCollapses","WithRichContent","FAQ","Disabled"];export{a as Default,p as Disabled,r as FAQ,o as NestedCollapses,t as OpenByDefault,n as ReactiveVModel,l as Variants,i as WithRichContent,g as __namedExportsOrder,b as default};
