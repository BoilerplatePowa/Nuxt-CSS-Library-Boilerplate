import{A as l}from"./Accordion-BJM1G8Az.js";import"./iframe-DKx4txre.js";import"./preload-helper-D9Z9MdNV.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const m={title:"Data Display/Accordion",component:l,parameters:{layout:"centered",docs:{description:{component:"Collapsible content component with customizable panels and smooth animations."}}},argTypes:{items:{control:"object",description:"Array of accordion items with title and content"},multiple:{control:"boolean",description:"Allow multiple panels to be open simultaneously"},variant:{control:{type:"select"},options:["default","bordered","compact"],description:"Accordion variant"},size:{control:{type:"select"},options:["sm","md","lg"],description:"Accordion size"},disabled:{control:"boolean",description:"Disable the accordion"},id:{control:"text",description:"Custom ID for the accordion (for accessibility and testing)"}},tags:["autodocs"]},n=[{value:"1",title:"What is your return policy?",content:"We offer a 30-day return policy for all unused items in original packaging. Return shipping is free for defective items."},{value:"2",title:"How long does shipping take?",content:"Standard shipping takes 3-5 business days. Express shipping is available for 1-2 day delivery."},{value:"3",title:"Do you ship internationally?",content:"Yes, we ship to over 50 countries worldwide. International shipping times vary by location."}],e={args:{items:n}},t={args:{items:n,multiple:!0}},i={args:{items:n,variant:"bordered"}},o={args:{items:n,variant:"compact"}},a={args:{items:[{value:"1",title:"🚀 Getting Started",content:`
        ...
        `}]}},r={render:()=>({components:{Accordion:l},template:`
      <div class="space-y-8">
        <div>
...
}`,...r.parameters?.docs?.source}}};const v=["Default","Multiple","Bordered","Compact","WithRichContent","Large","MultipleAccordions"];export{i as Bordered,o as Compact,e as Default,s as Large,t as Multiple,r as MultipleAccordions,a as WithRichContent,v as __namedExportsOrder,m as default};
